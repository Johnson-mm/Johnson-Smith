(function () {
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    // ===== USER LOCATION (FLAG + LOCAL TIME ONLY) =====
    ...
    if (locationEl) locationEl.textContent = flag; // only the flag emoji

    // ===== Update LOCAL TIME in UI =====
    ...
    if (locationEl) locationEl.textContent = "🌍"; // fallback globe emoji
